    ...
    <form @submit.prevent="validateBeforeSubmit">
        <table class="main form-pop">
            <tbody class="form-body">
                <tr>
                    <td class="label-tit">
                        <label for="new_matchinfor">种植区</label>
                    </td>
                    <td class="input-pop" colspan="2"><input v-model="letItem.plantation_name" type="text" id="residue_edit_plantation" name="plantation_name" disabled="disabled" class="input-pop"></td>
                </tr>
                <tr>
                    <td class="label-tit">
                    ...
                    <td class="input-pop" colspan="2">
                       <input v-model="letItem.harvest_serial" type="text" id="residue_harvest_edit_serial" name="harvest_serial" readonly="readonly" class="input-pop inp_not_color">
                     </td>
                </tr>
                <tr>
                    <td class="label-tit">
                ...
                <tr v-show="errors.has('residue_date')">
                    <td colspan="3" class="error">{{ errors.first('residue_date') }}</td>
                </tr>
                ...
                <tr v-show="errors.has('departments')">
                    <td colspan="3" class="error">{{ errors.first('departments') }}</td>
                </tr>
