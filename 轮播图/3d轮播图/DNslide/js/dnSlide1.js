  ...
  if (typeof define === 'function' && define.amd) {
    ...
    $[_PLUGIN_].prototype = {
        ...
        settingDOM : function (){
            ...
            this.resourceSrcArr = this.container.find('.slide-con').map(function(i,e){
                return e.innerHTML;
            });
            var ulDOM = this.container.html('<ul class="dnSlide-list"></ul>').find('.dnSlide-list');

            jQuery.each(this.resourceSrcArr , function(i,e){
                ulDOM.append('<li class="dnSlide-item"><div class="slide-con slide-img">'+_this_.resourceSrcArr[i]+'</div></li>');
            });
        ...
        isEvenPicNum:function(){
            if(this.dnSlideItemsLength%2 === 0){
                ...
                this.dnSlideItemsLength = $('ul.dnSlide-list>li').length;
                this.dnSlideFirstItem = $('ul.dnSlide-list>li:first-child');
                this.dnSlideLastItem = $('ul.dnSlide-list>li:last-child');
                this.dnSlideLi = this.container.find('.dnSlide-item');
            }
        },   
        _api_: function()
